...
switch-os: fmt
	...
	sudo -S nh os switch --verbose -- --max-jobs 20 --cores 20 --flake /home/exec/Projects/github.com/eval-exec/nixos-configuration/.#Mufasa --verbose --show-trace --print-build-logs 
