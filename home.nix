      ...
      accounts = {
        execvy = {
          ...
          imapnotify = {
            ...
            '';
            onNotifyPost = "/home/exec/Projects/git.savannah.gnu.org/git/emacs-build/emacs/bin/emacsclient -e '(progn (unless mu4e--server-process (mu4e t)) (mu4e-update-index-nonlazy)(message \"imapnotify received new mail.\"))'";
          };
